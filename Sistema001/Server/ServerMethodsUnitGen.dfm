object ServerMethodsGen: TServerMethodsGen
  ...
  object dspForItensCons: TDataSetProvider
    DataSet = sqlForItensCons
    Left = 128
    Top = 664
  end
  object sqlForItensCons: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      
        'select  "tblprodutos"."codproduto","tblprodutos"."descricao", su' +
        'm( "tblestoqueexp"."qtd") as qtde'
      'from "tblestoqueexp"'
      
        'inner join "tblprodutos" on ("tblprodutos"."id" = "tblestoqueexp' +
        '"."idprod")'
      'group by "tblprodutos"."codproduto","tblprodutos"."descricao"')
    SQLConnection = DMCnn.dbxCnn
    Left = 32
    Top = 664
    object sqlForItensConscodproduto: TIntegerField
      FieldName = 'codproduto'
    end
    object sqlForItensConsdescricao: TStringField
      FieldName = 'descricao'
      Size = 50
    end
