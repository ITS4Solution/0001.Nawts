inherited F_SaidaProducaoBt: TF_SaidaProducaoBt
  Caption = 'Saida Produ'#231#227'o'
  ClientHeight = 646
  ClientWidth = 628
  OnCreate = FormCreate
  ExplicitWidth = 646
  ...
  object lbCodEnvase: TLabeledEdit [8]
    Left = 197
    Top = 19
    Width = 121
    Height = 21
    EditLabel.Width = 61
    EditLabel.Height = 13
    EditLabel.Caption = 'C'#243'd. Envase'
    ReadOnly = True
    TabOrder = 2
  end
  object recQnt: TPanel [9]
    Left = 189
    Top = 240
    Width = 278
    Height = 103
  ...
  object edtRequisitada: TEdit [11]
    Left = 451
    Top = 19
    Width = 121
    Height = 21
  ...
  object lbOperador: TLabeledEdit [12]
    Left = 324
    Top = 56
    Width = 162
    Height = 21
  ...
  object Panel3: TPanel [13]
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        ...
        object cxGrid1DBTableView1QTDINST: TcxGridDBColumn
          Caption = 'Qtd. Requisitada'
          DataBinding.FieldName = 'QTDINST'
          Width = 97
        end
  ...
  object Panel2: TPanel [14]
    ...
    object cxGrid2: TcxGrid
      ...
      object cxGrid2DBTableView1: TcxGridDBTableView
        Navigator.Buttons.CustomButtons = <>
        DataController.DataSource = dsSaidaProd
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <>
        DataController.Summary.SummaryGroups = <>
        ...
        object cxGrid2DBTableView1quantd: TcxGridDBColumn
          Caption = 'Qtd'
  ...
  object lbStatus: TLabeledEdit [15]
    Left = 491
    Top = 56
    Width = 121
    Height = 21
  ...
  object lbProduto: TLabeledEdit [18]
    Left = 197
    Top = 94
    Width = 289
    Height = 21
  ...
  object lbQtdPrevista: TLabeledEdit [19]
    Left = 324
    Top = 19
    Width = 121
    Height = 21
    EditLabel.Width = 60
    EditLabel.Height = 13
    EditLabel.Caption = 'Qtd Prevista'
    ReadOnly = True
    TabOrder = 3
  end
  object edtTotal: TEdit [20]
    Left = 492
    Top = 133
    Width = 120
    Height = 21
  ...
  object btnCalcular: TAdvGlassButton [21]
    AlignWithMargins = True
    Left = 449
    Top = 136
    Width = 36
  ...
  inherited Panel1: TPanel
    ...
    object AdvGlassButton1: TAdvGlassButton
      ...
      BackColor = 6052956
      Caption = 'Enviar embalagens para Envase'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
  ...
  object oCds: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspSaidaProducaoBT'
  ...
  object cdsDetalheEnvase: TClientDataSet
    ...
    ProviderName = 'dspSaidaDetalheBt2'
    RemoteServer = DM.ShCoGen
    Left = 32
    Top = 232
    ...
    object cdsDetalheEnvaseQTDINST: TSingleField
      FieldName = 'QTDINST'
      DisplayFormat = '#,##0.00'
    end
  end
  ...
  object cdsSaidaProd: TClientDataSet
    ...
    object cdsSaidaProdquantd: TSingleField
      FieldName = 'quantd'
    end
    ...
    object cdsSaidaProdidordemenvase: TIntegerField
  ...
  object ReportSaidaP: TfrxReport
    Version = '5.4.6'
    ...
    ReportOptions.LastChange = 43452.592331435180000000
    ...
    Datasets = <
      item
        ...
        DataSetName = 'dbDetalheEnvase'
      end
      item
        DataSet = F_SaidaProducao.dboCds
        DataSetName = 'dboCds'
      end
      item
        DataSet = dbSaidaProd
        DataSetName = 'dbSaidaProducao'
      end
      item
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object dboCdscodopenvase: TfrxMemoView
        ...
        object dboCdsqtdprevista: TfrxMemoView
          Left = 124.724490000000000000
          Top = 37.795300000000000000
          Width = 181.417440000000000000
          Height = 18.897650000000000000
        ...
        object dboCdsdata: TfrxMemoView
        ...
        object dboCdshora: TfrxMemoView
        ...
        object dboCdsoperador: TfrxMemoView
        ...
        object dboCdsstatus: TfrxMemoView
          Left = 529.134200000000000000
          Top = 37.795300000000000000
        ...
        object dboCdsdescricao: TfrxMemoView
      ...
      object MasterData1: TfrxMasterData
        ...
        object dbDetalheEnvaseue: TfrxMemoView
        ...
        object dbDetalheEnvaseqtd: TfrxMemoView
          ...
          Memo.UTF8W = (
            '[dbDetalheEnvase."QTDINST"]')
        end
        object dbDetalheEnvasecodproduto: TfrxMemoView
      ...
      object MasterData2: TfrxMasterData
        ...
        object dbSaidaProducaodata: TfrxMemoView
          Left = 548.031850000000000000
          Top = 3.779530000000000000
          Width = 79.370130000000000000
          Height = 18.897650000000000000
          ...
          DataSetName = 'dbSaidaProducao'
          Memo.UTF8W = (
            '[dbSaidaProducao."data"]')
        end
        object dbSaidaProducaohora: TfrxMemoView
          ...
          DataSetName = 'dbSaidaProducao'
          Memo.UTF8W = (
            '[dbSaidaProducao."hora"]')
        end
        object dbSaidaProducaoquantd: TfrxMemoView
          ...
          DataSetName = 'dbSaidaProducao'
          Memo.UTF8W = (
            '[dbSaidaProducao."quantd"]')
        end
        object dbSaidaProducaodescricao: TfrxMemoView
          Left = 3.779530000000000000
          Top = 3.779530000000000000
      ...
      object MasterData3: TfrxMasterData
        ...
        object dbTotalQtdTotal: TfrxMemoView
        ...
        object dbTotalSobra: TfrxMemoView
          Left = 7.559060000000000000
          Top = 30.236240000000000000
        ...
        object dbTotalPerca: TfrxMemoView
  ...
  object dbSaidaProd: TfrxDBDataset
    UserName = 'dbSaidaProducao'
    CloseDataSource = False
    FieldAliases.Strings = (
      'descricao=descricao'
      'id=id'
      ...
      'obs=obs'
      'quantd=quantd'
      'idordemenvase=idordemenvase'
      'idordemquimico=idordemquimico'
      'idproduto=idproduto'
      'lote=lote'
      'dataval=dataval'
      'local=local'
  ...
  object cdsTotal: TClientDataSet
    ...
    ProviderName = 'dspCalculaTotal'
    RemoteServer = DM.ShCoGen
    OnCalcFields = cdsTotalCalcFields
    Left = 80
    Top = 128
    object cdsTotalTOTAL: TFloatField
      FieldName = 'TOTAL'
    end
    object cdsTotalQtdTotal: TIntegerField
      FieldKind = fkCalculated
      FieldName = 'QtdTotal'
      Calculated = True
    end
    object cdsTotalSobra: TIntegerField
      FieldKind = fkCalculated
      FieldName = 'Sobra'
      Calculated = True
    end
    object cdsTotalPerca: TIntegerField
      FieldKind = fkCalculated
      FieldName = 'Perca'
      Calculated = True
    end
