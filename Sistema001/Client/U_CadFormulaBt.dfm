inherited F_CadFormulaBt: TF_CadFormulaBt
  ...
  object Label1: TLabel [7]
    ...
    Width = 114
    Height = 13
    Caption = 'C'#243'd. Processo Acabado'
  end
  ...
  inherited Panel1: TPanel
    ...
    ExplicitTop = 472
    ExplicitWidth = 709
    object btnImprimi: TAdvGlassButton [0]
      Left = 423
      Top = 13
      Width = 100
      Height = 32
  ...
  object cxDBTextEdit2: TcxDBTextEdit [11]
    Left = 276
    Top = 18
    DataBinding.DataField = 'descricaoformula'
    DataBinding.DataSource = oDS
    TabOrder = 1
    Width = 381
  end
  object cxDBMemo1: TcxDBMemo [12]
    Left = 189
    Top = 97
  ...
  object Panel2: TPanel [14]
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        ...
        DataController.DataSource = DSFormuladetalhe
        ...
        object cxGrid1DBTableView1idmateriaprima: TcxGridDBColumn
          Caption = 'Mat'#233'ria Prima '
          DataBinding.FieldName = 'idmateriaprima'
          ...
          Properties.ListSource = dsInsumoID
          Properties.OnCloseUp = cxGrid1DBTableView1idmateriaprimaPropertiesCloseUp
          Properties.OnPopup = cxGrid1DBTableView1idmateriaprimaPropertiesPopup
          Width = 604
        end
  ...
  object cxDBLookupComboBox1: TcxDBLookupComboBox [15]
    Left = 189
    Top = 58
    DataBinding.DataField = 'idcodprocesso'
    DataBinding.DataSource = oDS
  ...
  object recMult: TPanel [17]
    ...
    object Label6: TLabel
      ...
      Height = 14
      Align = alTop
      Caption = 'Digite o multiplicador'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -12
      Font.Name = 'Tahoma'
  ...
  inherited oCds: TClientDataSet
    ...
    object oCdscodproduto: TStringField
      FieldName = 'codproduto'
    end
  end
  object CdsFormuladetalhe: TClientDataSet
    ...
    RemoteServer = DM.ShCoGen
    AfterInsert = CdsFormuladetalheAfterInsert
    OnCalcFields = CdsFormuladetalheCalcFields
    Left = 56
    Top = 144
    ...
    object CdsFormuladetalheTotal: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'Total'
      DisplayFormat = '#,###0.000'
      EditFormat = '#,###0.000'
    end
    object CdsFormuladetalhemulti: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'multi'
    end
  ...
  object DSFormuladetalhe: TDataSource
    DataSet = CdsFormuladetalhe
    Left = 88
    Top = 144
  end
  ...
  object ReportFormula: TfrxReport
    Version = '5.4.6'
    ...
    ReportOptions.LastChange = 43292.464507280090000000
    ...
    Datasets = <
      ...
      item
        DataSet = DBFormula
        DataSetName = 'dbFormula'
      end
      item
        DataSet = dbInsumo
        DataSetName = 'dbInsumoDescricao'
      end
      item
        DataSet = DBcdsProduto
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object dbCDSpercentual: TfrxMemoView
        ...
        object dbCDScodigo: TfrxMemoView
        ...
        object dbCDSdescricaoformula: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[dbCDS."descricaoformula"]')
          ParentFont = False
        end
        object dbProdutocodproduto: TfrxMemoView
      ...
      object MasterData1: TfrxMasterData
        ...
        object dbFormulaTOTAL: TfrxMemoView
          Left = 616.063390000000000000
          Top = 3.779530000000022000
          Width = 94.488250000000000000
          Height = 18.897650000000000000
        ...
        object dbFormulaMULTI: TfrxMemoView
        ...
        object dbInsumoDescricaocodigo: TfrxMemoView
          Left = 3.779530000000000000
  ...
  object DBcdsProduto: TfrxDBDataset
    UserName = 'dbProduto'
    CloseDataSource = False
    DataSet = cdsProdutos
    BCDToCurrency = False
  ...
  object cdsInsumoID: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspInsumoID'
    RemoteServer = DM.ShCoGen
    OnCalcFields = cdsInsumoIDCalcFields
    Left = 88
    Top = 8
    object cdsInsumoIDid: TIntegerField
      FieldName = 'id'
      Required = True
    end
    object cdsInsumoIDdescricao: TStringField
      FieldName = 'descricao'
      Size = 100
    end
    object cdsInsumoIDcodigo: TStringField
      FieldName = 'codigo'
      Size = 30
    end
  end
  object dsInsumoID: TDataSource
    DataSet = cdsInsumoID
    Left = 152
    Top = 16
  end
