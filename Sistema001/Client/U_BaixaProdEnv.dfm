object F_BaixaProdEnv: TF_BaixaProdEnv
  Left = 0
  Top = 0
  Caption = 'Baixa de Produto Acabado'
  ClientHeight = 406
  ClientWidth = 754
  Color = clSilver
  ...
  object Label1: TLabel
    ...
    Width = 115
    Height = 13
    Caption = 'Selecione o arquivo XML'
  end
  object Panel1: TPanel
    ...
    DesignSize = (
      754
      55)
    object btnLista: TAdvGlassButton
      Left = 538
      Top = 12
      Width = 100
      Height = 32
    ...
    object btnBaixa: TAdvGlassButton
      Left = 644
      Top = 12
      Width = 100
      Height = 32
  ...
  object Panel2: TPanel
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        ...
        object cxGrid1DBTableView1sITEM: TcxGridDBColumn
          Caption = 'Itens'
          DataBinding.FieldName = 'sITEM'
          Width = 36
        end
        object cxGrid1DBTableView1sCOD: TcxGridDBColumn
          Caption = 'C'#243'digo'
          DataBinding.FieldName = 'sCOD'
          Width = 68
        end
        object cxGrid1DBTableView1sNOMEP: TcxGridDBColumn
          Caption = 'Descri'#231#227'o'
          DataBinding.FieldName = 'sNOMEP'
          Width = 465
        end
  ...
  object cdsBaixa: TClientDataSet
    ...
    Left = 8
    Top = 72
    object cdsBaixasNOMEP: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'sNOMEP'
      Size = 50
    end
    object cdsBaixasITEM: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'sITEM'
      Size = 5
    end
    ...
    object cdsBaixaidop: TIntegerField
      FieldName = 'idop'
    end
    object cdsBaixaidprod: TIntegerField
      FieldName = 'idprod'
    end
    object cdsBaixaqtd: TSingleField
      FieldName = 'qtd'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object cdsBaixadataexp: TDateField
      FieldName = 'dataexp'
    end
    object cdsBaixahoraexp: TTimeField
      FieldName = 'horaexp'
    end
    object cdsBaixasCOD: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'sCOD'
      Size = 10
    end
    object cdsBaixanumnf: TStringField
      FieldName = 'numnf'
      Size = 15
    end
    object cdsBaixanomecliente: TStringField
