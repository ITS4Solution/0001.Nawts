object F_RelatFornecedor: TF_RelatFornecedor
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  Caption = 'Relat'#243'rio por Fornecedor '
  ClientHeight = 205
  ClientWidth = 527
  Color = clSilver
  ...
  object ocdsFornecedor: TClientDataSet
    ...
    object ocdsFornecedordataIni: TDateField
      FieldKind = fkInternalCalc
      FieldName = 'dataIni'
    end
    object ocdsFornecedordataFim: TDateField
      FieldKind = fkInternalCalc
      FieldName = 'dataFim'
    end
  end
  object cdsRelat: TClientDataSet
    ...
    ProviderName = 'dspRelatForn'
    RemoteServer = DM.ShCoGen
    OnCalcFields = cdsRelatCalcFields
    Left = 16
    Top = 56
    object cdsRelatNFEID: TIntegerField
      FieldName = 'NFEID'
      Required = True
    end
    object cdsRelatid: TIntegerField
      FieldName = 'id'
      Required = True
    end
    object cdsRelatnronfe: TIntegerField
      FieldName = 'nronfe'
    end
    object cdsRelatserienfe: TIntegerField
      FieldName = 'serienfe'
    end
    object cdsRelatdata: TDateField
      FieldName = 'data'
    end
    object cdsRelatcodfiscal: TIntegerField
      FieldName = 'codfiscal'
    end
    object cdsRelatcodfornecedor: TIntegerField
      FieldName = 'codfornecedor'
    end
    object cdsRelatcondpagamento: TStringField
      FieldName = 'condpagamento'
      Size = 30
    end
    object cdsRelatdetalhepagamento: TStringField
      FieldName = 'detalhepagamento'
      Size = 50
    end
    object cdsRelattipomaterial: TStringField
      FieldName = 'tipomaterial'
      Size = 10
    end
    object cdsRelatvalornfe: TSingleField
      FieldName = 'valornfe'
    end
    object cdsRelatvalorcalculado: TSingleField
      FieldName = 'valorcalculado'
    end
    object cdsRelatobs: TMemoField
      FieldName = 'obs'
      BlobType = ftMemo
      Size = 1
    end
    object cdsRelatlote: TIntegerField
      FieldName = 'lote'
    end
    object cdsRelatnome_razaosocial: TStringField
      FieldName = 'nome_razaosocial'
      Size = 50
    end
    object cdsRelatCODFORN: TIntegerField
      FieldName = 'CODFORN'
    end
    object cdsRelatid_1: TIntegerField
      FieldName = 'id_1'
    end
    object cdsRelatcodnfeentrada: TIntegerField
      FieldName = 'codnfeentrada'
    end
    object cdsRelatcodproduto: TStringField
      FieldName = 'codproduto'
      Size = 30
    end
    object cdsRelatUE: TStringField
      FieldName = 'UE'
      Size = 10
    end
    object cdsRelatqtde: TSingleField
      FieldName = 'qtde'
    end
    object cdsRelatvlrunitario: TSingleField
      FieldName = 'vlrunitario'
    end
    object cdsRelatvaloripi: TSingleField
      FieldName = 'valoripi'
    end
    object cdsRelatvalortotal: TSingleField
      FieldName = 'valortotal'
    end
    object cdsRelatcodfornecedor_1: TIntegerField
      FieldName = 'codfornecedor_1'
    end
    object cdsRelatcodfiscal_1: TStringField
      FieldName = 'codfiscal_1'
      Size = 10
    end
    object cdsRelatlote_1: TStringField
      FieldName = 'lote_1'
    end
    object cdsRelatvalidade: TDateField
      FieldName = 'validade'
    end
    object cdsRelatnroregistro: TIntegerField
      FieldName = 'nroregistro'
    end
    object cdsRelatpercentagemicms: TSingleField
      FieldName = 'percentagemicms'
    end
    object cdsRelatteveaumento: TSmallintField
      FieldName = 'teveaumento'
    end
    object cdsRelatgeraetiqueta: TSmallintField
      FieldName = 'geraetiqueta'
    end
    object cdsRelatcadastradf: TSmallintField
      FieldName = 'cadastradf'
    end
    object cdsRelatncm: TStringField
      FieldName = 'ncm'
      Size = 15
    end
    object cdsRelatitem: TIntegerField
      FieldName = 'item'
    end
    object cdsRelatsequencial: TIntegerField
      FieldName = 'sequencial'
    end
    object cdsRelatdescricao: TStringField
      FieldName = 'descricao'
      Size = 100
    end
    object cdsRelatcodigo: TStringField
      FieldName = 'codigo'
      Size = 30
    end
  end
  ...
  object ReportNFForn: TfrxReport
    Version = '5.4.6'
    ...
    ReportOptions.LastChange = 43447.643913009260000000
    ...
    object Page1: TfrxReportPage
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        object CabFornecedornronfe: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[CabFornecedor."nronfe"]')
          ParentFont = False
        end
        object Memo18: TfrxMemoView
          Left = 387.921460000000000000
          Top = 219.094620000000000000
        ...
        object Memo31: TfrxMemoView
          ...
          DataSetName = 'CabFornecedor'
          Memo.UTF8W = (
            '[CabFornecedor."nome_razaosocial"]')
        end
        object Memo32: TfrxMemoView
          ...
          DataSetName = 'CabFornecedor'
          Memo.UTF8W = (
            '[CabFornecedor."detalhepagamento"]')
        end
        ...
        object Memo6: TfrxMemoView
          ...
          Height = 18.897650000000000000
          Memo.UTF8W = (
            '[SUM(<CabFornecedor."valortotal">,MasterData1)]')
        end
      end
      object MasterData1: TfrxMasterData
        ...
        object CabFornecedorcodigo: TfrxMemoView
          Left = 3.779530000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[CabFornecedor."codproduto"]')
          ParentFont = False
        end
        object CabFornecedordescricao: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[CabFornecedor."descricao"]')
          ParentFont = False
        end
        object CabFornecedorUE: TfrxMemoView
        ...
        object CabFornecedorncm: TfrxMemoView
          Left = 483.779840000000000000
          Top = 3.779530000000000000
          Width = 64.252010000000000000
          Height = 18.897650000000000000
        ...
        object CabFornecedorqtde: TfrxMemoView
        ...
        object CabFornecedorvlrunitario: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[CabFornecedor."vlrunitario"]')
          ParentFont = False
        end
        object CabFornecedorpercentagemicms: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[CabFornecedor."percentagemicms"]')
          ParentFont = False
        end
        object CabFornecedorvaloripi: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[CabFornecedor."valoripi"]')
          ParentFont = False
        end
        object CabFornecedorlote: TfrxMemoView
          Left = 797.480830000000000000
          Top = 3.779530000000000000
          Width = 68.031540000000000000
          Height = 18.897650000000000000
        ...
        object CabFornecedorvalidade: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[CabFornecedor."validade"]')
          ParentFont = False
        end
        object CabFornecedorvalortotal: TfrxMemoView
  ...
  object Fornecedor: TfrxDBDataset
    UserName = 'Fornecedor'
  ...
  object Cab: TfrxDBDataset
    UserName = 'CabFornecedor'
    CloseDataSource = False
    DataSet = cdsRelat
    BCDToCurrency = False
    Left = 224
  ...
  object ReportNfVazio: TfrxReport
    Version = '5.4.6'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.AllowEdit = False
    ...
    PrintOptions.ShowDialog = False
    ReportOptions.CreateDate = 42671.408074351800000000
    ReportOptions.LastChange = 43448.467803101850000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo36: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'N'#227'o foi encontrado nenhum registro.')
          ParentFont = False
        end
        object Memo1: TfrxMemoView
          Left = 15.118120000000000000
        ...
        object Fornecedornome_razaosocial: TfrxMemoView
        ...
        object FornecedordataIni: TfrxMemoView
          Left = 124.724490000000000000
        ...
        object FornecedordataFim: TfrxMemoView
          Left = 124.724490000000000000
          Top = 245.669450000000000000
          Width = 400.630180000000000000
          Height = 18.897650000000000000
