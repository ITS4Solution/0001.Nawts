object F_EtiquetaRegistro: TF_EtiquetaRegistro
  Left = 0
  Top = 0
  Caption = 'Etiqueta Registro'
  ClientHeight = 201
  ClientWidth = 513
  Color = clSilver
  ...
  object reportEtiquetaRegistro: TfrxReport
    Version = '5.4.6'
    ...
    ReportOptions.CreateDate = 43282.630293321800000000
    ReportOptions.LastChange = 43294.479983449080000000
    ...
    Datasets = <
      item
        DataSet = dbEtiquetaRegistro
        DataSetName = 'dbEtiquetaRegistro'
      end>
    Variables = <>
    Style = <>
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object dbEtiquetaRegistrosMP: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[dbEtiquetaRegistro."sMP"]')
          ParentFont = False
        end
        object dbEtiquetaRegistrosRegistro: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[dbEtiquetaRegistro."sRegistro"]')
          ParentFont = False
        end
        object dbEtiquetaRegistrosData: TfrxMemoView
  ...
  object dbEtiquetaRegistro: TfrxDBDataset
    UserName = 'dbEtiquetaRegistro'
  ...
  object cdsReg: TClientDataSet
    ...
    Left = 24
    Top = 16
    object cdsRegsSeq: TStringField
      FieldName = 'sSeq'
      Size = 10
    end
    object cdsRegsMP: TStringField
      FieldName = 'sMP'
      Size = 10
    end
    object cdsRegsRegistro: TStringField
      FieldName = 'sRegistro'
      Size = 10
    end
    object cdsRegsData: TStringField
      FieldName = 'sData'
      Size = 15
    end
  end
