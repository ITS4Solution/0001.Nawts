object F_EtiquetaAprov: TF_EtiquetaAprov
  Left = 0
  Top = 0
  Caption = 'Etiqueta Aprovado'
  ClientHeight = 190
  ClientWidth = 570
  Color = clSilver
  ...
  object cxDBTextEdit1: TcxDBTextEdit
    ...
    DataBinding.DataSource = dsAprov
    TabOrder = 1
    Width = 78
  end
  ...
  object dbEtiquetaAprov: TfrxDBDataset
    UserName = 'dbEtiquetaAprov'
  ...
  object cdsAprov: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 16
    Top = 64
    object cdsAprovsSeq: TStringField
      FieldName = 'sSeq'
      Size = 10
    end
    object cdsAprovsTipo: TStringField
      FieldName = 'sTipo'
    end
    object cdsAprovsData: TStringField
      FieldName = 'sData'
      Size = 15
    end
    object cdsAprovsDescr: TStringField
      FieldName = 'sDescr'
      Size = 50
    end
    object cdsAprovsResp: TStringField
      FieldName = 'sResp'
      Size = 50
    end
  end
  object dsAprov: TDataSource
    DataSet = cdsAprov
    Left = 48
    Top = 64
  end
  object frxReport1: TfrxReport
    ...
    ReportOptions.CreateDate = 43355.494393206020000000
    ReportOptions.LastChange = 43355.494393206020000000
  ...
  object reportEtiquetaAprovadoNew: TfrxReport
    Version = '5.4.6'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 43357.622568726900000000
    ReportOptions.LastChange = 43357.622568726900000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
    ...
    Datasets = <
      item
        DataSet = dbEtiquetaAprov
        DataSetName = 'dbEtiquetaAprov'
      end>
    Variables = <>
    Style = <>
    object Data: TfrxDataPage
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Shape3: TfrxShapeView
          Top = 243.102350000000000000
          Width = 300.488250000000000000
          Height = 25.897650000000000000
          Shape = skRoundRectangle
        end
        ...
        object dbEtiquetaAprovsDescr: TfrxMemoView
          ...
          Font.Style = [fsBold]
          Memo.UTF8W = (
            '[dbEtiquetaAprov."sDescr"]')
          ParentFont = False
        end
        object dbEtiquetaAprovsData: TfrxMemoView
          Left = 107.000000000000000000
          Top = 196.102350000000000000
          Width = 74.944960000000000000
          Height = 18.897650000000000000
          DataField = 'sData'
          DataSet = dbEtiquetaAprov
          DataSetName = 'dbEtiquetaAprov'
          ...
          Font.Style = [fsBold]
          Memo.UTF8W = (
            '[dbEtiquetaAprov."sData"]')
          ParentFont = False
        end
        object dbEtiquetaAprovsResp: TfrxMemoView
          ...
          Font.Style = [fsBold]
          Memo.UTF8W = (
            '[dbEtiquetaAprov."sResp"]')
          ParentFont = False
        end
      end
      object MasterData2: TfrxMasterData
        FillType = ftBrush
        Height = 280.818897640000000000
        ...
        object Shape8: TfrxShapeView
          Left = 100.000000000000000000
          Top = 189.739950000000000000
          Width = 92.488250000000000000
          Height = 29.897650000000000000
          Shape = skRoundRectangle
        end
        object Shape9: TfrxShapeView
          Top = 242.739950000000000000
          Width = 300.488250000000000000
          Height = 25.897650000000000000
          Shape = skRoundRectangle
        end
