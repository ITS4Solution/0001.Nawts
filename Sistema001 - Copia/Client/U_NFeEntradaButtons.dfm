inherited F_NFeEntradaButtons: TF_NFeEntradaButtons
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        ...
        object cxGrid1DBTableView1codproduto: TcxGridDBColumn
          ...
          Properties.OnCloseUp = cxGrid1DBTableView1codprodutoPropertiesCloseUp
  ...
  object cxDBLookupComboBox1: TcxDBLookupComboBox [21]
    Left = 189
    Top = 65
  ...
  object oCdsNFeEntradaItens: TClientDataSet
    ...
    object oCdsNFeEntradaItensvaloripi: TSingleField
      FieldName = 'valoripi'
      OnChange = oCdsNFeEntradaItensvaloripiChange
      DisplayFormat = '#,##0.00'
    end
    ...
    object oCdsNFeEntradaItenspercentagemicms: TSingleField
      ...
      OnChange = oCdsNFeEntradaItenspercentagemicmsChange
      DisplayFormat = '#,##0.00'
    end
    ...
    object oCdsNFeEntradaItenssNomeForn: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'sNomeForn'
      Size = 60
    end
    object oCdsNFeEntradaItensiCodForn: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'iCodForn'
    end
    object oCdsNFeEntradaItenssCodInsumo: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'sCodInsumo'
      Size = 10
    end
  ...
  object oCdsInsumos: TClientDataSet
    ...
    object oCdsInsumossCod: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'sCod'
      Size = 10
    end
    object oCdsInsumoslote: TStringField
      FieldName = 'lote'
      Size = 50
    end
    object oCdsInsumossProduto: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'sProduto'
      Size = 120
    end
  ...
  object cdstblEstoqueInsumos: TClientDataSet
    ...
    object cdstblEstoqueInsumosidordemenvase: TIntegerField
      FieldName = 'idordemenvase'
    end
    object cdstblEstoqueInsumosidordemquimico: TIntegerField
      FieldName = 'idordemquimico'
    end
    object cdstblEstoqueInsumosidproduto: TIntegerField
      FieldName = 'idproduto'
    end
    object cdstblEstoqueInsumoslote: TStringField
      FieldName = 'lote'
      Size = 40
    end
    object cdstblEstoqueInsumosdataval: TDateField
      FieldName = 'dataval'
    end
  end
  object ReportNFe: TfrxReport
    ...
    ReportOptions.LastChange = 43069.361149895800000000
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo8: TfrxMemoView
          Left = 31.464440000000000000
          Top = 67.440939999999970000
          Width = 94.488250000000000000
          Height = 18.897650000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object SumVALORTOTAL: TfrxMemoView
        ...
        object EntradaItensiCodForn: TfrxMemoView
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'dbItens'
        RowCount = 0
        object dbItensdescricao: TfrxMemoView
        ...
        object dbItensncm: TfrxMemoView
        ...
        object dbItensqtde: TfrxMemoView
        ...
        object dbItensvlrunitario: TfrxMemoView
        ...
        object dbItenspercentagemicms: TfrxMemoView
          Left = 680.315400000000000000
          Top = 3.779530000000022000
          Width = 56.692950000000000000
          Height = 18.897650000000000000
          DataField = 'percentagemicms'
          DataSet = dbItens
          DataSetName = 'dbItens'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[dbItens."percentagemicms"]')
          ParentFont = False
        end
        object dbItensvaloripi: TfrxMemoView
        ...
        object dbItenslote: TfrxMemoView
        ...
        object dbItensvalidade: TfrxMemoView
        ...
        object dbItensvalortotal: TfrxMemoView
        ...
        object dbItenscodproduto: TfrxMemoView
          Top = 3.779530000000022000
          Width = 60.472480000000000000
          Height = 18.897650000000000000
          DataField = 'codigo'
  ...
  object ReportMP: TfrxReport
    ...
    ReportOptions.LastChange = 43159.548909594910000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object EntradaItenssequencial: TfrxMemoView
          Left = 180.196970000000000000
          Top = 43.118120000000000000
          Width = 514.016080000000000000
          Height = 18.897650000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[EntradaItens."sequencial"]')
          ParentFont = False
        end
        object EntradaItenssNomeForn: TfrxMemoView
        ...
        object EntradaItenssCodInsumo: TfrxMemoView
          Left = 165.078850000000000000
          Top = 69.574829999999990000
          Width = 529.134199999999900000
          Height = 18.897650000000000000
          DataField = 'sCodInsumo'
          DataSet = DBEntradaItens
          DataSetName = 'EntradaItens'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[EntradaItens."sCodInsumo"]')
          ParentFont = False
        end
        object Memo15: TfrxMemoView
          Left = 13.897650000000000000
          Top = 17.236240000000010000
          Width = 94.488250000000000000
          Height = 18.897650000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
  ...
  object cdsNfeID: TClientDataSet
    ...
    object cdsNfeIDiCodForn: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'iCodForn'
    end
  end
  ...
  object cdsSUM: TClientDataSet
    ...
    ProviderName = 'dspNfeSum'
    RemoteServer = DM.ShCoGen
    OnCalcFields = cdsSUMCalcFields
    Left = 56
    Top = 296
    object cdsSUMVALORTOTAL: TFloatField
      FieldName = 'VALORTOTAL'
      DisplayFormat = '#,##0.00'
    end
    object cdsSUMNomeForne: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'NomeForne'
      Size = 50
    end
    object cdsSUMCodForne: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'CodForne'
    end
  end
  object DBSum: TfrxDBDataset
    UserName = 'Sum'
    CloseDataSource = False
    DataSet = cdsSUM
    BCDToCurrency = False
  ...
  object cdsNomePr: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftWideString
    ...
    ProviderName = 'dspNomePro'
    RemoteServer = DM.ShCoGen
    Left = 56
    Top = 216
    object cdsNomePrdescricao: TStringField
      FieldName = 'descricao'
      Size = 100
    end
  end
  object dsNomePr: TDataSource
    Left = 96
    Top = 216
  end
  object cdsImp: TClientDataSet
    ...
    object cdsImpcodnfeentrada: TIntegerField
      FieldName = 'codnfeentrada'
    end
    object cdsImpcodproduto: TStringField
      FieldName = 'codproduto'
      Size = 30
    end
    object cdsImpUE: TStringField
      FieldName = 'UE'
      Size = 10
    end
    object cdsImpqtde: TSingleField
      FieldName = 'qtde'
    end
    object cdsImpvlrunitario: TSingleField
      FieldName = 'vlrunitario'
    end
    object cdsImpvaloripi: TSingleField
      FieldName = 'valoripi'
    end
    object cdsImpvalortotal: TSingleField
      FieldName = 'valortotal'
    end
    object cdsImpcodfornecedor: TIntegerField
      FieldName = 'codfornecedor'
    end
    object cdsImpcodfiscal: TStringField
      FieldName = 'codfiscal'
      Size = 10
    end
    object cdsImplote: TStringField
      FieldName = 'lote'
    end
    object cdsImpvalidade: TDateField
      FieldName = 'validade'
    end
    object cdsImpnroregistro: TIntegerField
      FieldName = 'nroregistro'
    end
    object cdsImppercentagemicms: TSingleField
      FieldName = 'percentagemicms'
    end
    object cdsImpteveaumento: TSmallintField
      FieldName = 'teveaumento'
    end
    object cdsImpgeraetiqueta: TSmallintField
      FieldName = 'geraetiqueta'
    end
    object cdsImpcadastradf: TSmallintField
      FieldName = 'cadastradf'
    end
    object cdsImpncm: TStringField
      FieldName = 'ncm'
      Size = 15
    end
    object cdsImpitem: TIntegerField
      FieldName = 'item'
    end
    object cdsImpsequencial: TIntegerField
      FieldName = 'sequencial'
    end
    ...
    object cdsImpcodigo: TStringField
      FieldName = 'codigo'
      Size = 30
    end
  end
