...
function EnviarEmail(sArquivo,aHost : String; aPort : Integer; aLogin, aSenha,aListaEmail, aAssunto, aCorpo : String; aAuth, aAuthSSL : Boolean) : Boolean;
...
begin
  ...
  try
    ...
    TIdAttachmentFile.Create(IdMessage.MessageParts, TFileName(sArquivo)); // adiciona anexo na lista, pode ser utilizado com looping
