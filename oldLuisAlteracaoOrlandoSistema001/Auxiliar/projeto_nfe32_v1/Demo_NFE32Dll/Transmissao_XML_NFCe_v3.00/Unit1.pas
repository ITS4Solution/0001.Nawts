...
{$R *.dfm}
 ...
 //usa_SCAN substituido por iContingencia, o qual contempla a relação de Webservices de Contingência
 function fncNFCeAutorizacao     (sXML: PChar; iUF, iTipo: integer; versaoDados: PChar; iContingencia: integer; retorno_detalhado: Boolean; IgnoreInvalidCert: Boolean): PChar; stdcall; external 'transmissaoNFCe32dll.dll';
 function fncNFCeRetAutorizacao  (sXML: PChar; iUF, iTipo: integer; versaoDados: PChar; iContingencia: integer; retorno_detalhado: Boolean; IgnoreInvalidCert: Boolean): PChar; stdcall; external 'transmissaoNFCe32dll.dll';
 function fncNFCeConsulta        (sXML: PChar; iUF, iTipo: integer; versaoDados: PChar; iContingencia: integer; retorno_detalhado: Boolean; IgnoreInvalidCert: Boolean): PChar; StdCall; external 'transmissaoNFCe32dll.dll';
 function fncNFCeInutilizacao    (sXML: PChar; iUF, iTipo: integer; versaoDados: PChar; iContingencia: integer; retorno_detalhado: Boolean; IgnoreInvalidCert: Boolean): PChar; StdCall; external 'transmissaoNFCe32dll.dll';
 function fncNFCeStatusServico   (sXML: PChar; iUF, iTipo: integer; versaoDados: PChar; iContingencia: integer; retorno_detalhado: Boolean; IgnoreInvalidCert: Boolean): PChar; StdCall; external 'transmissaoNFCe32dll.dll';
 function fncNFCeRecepcaoEvento  (sXML: PChar; iUF, iTipo: integer; versaoDados: PChar; iContingencia: integer; retorno_detalhado: Boolean; IgnoreInvalidCert: Boolean): PChar; StdCall; external 'transmissaoNFCe32dll.dll';
 ...
 function fncNFCeAutorizacaoPath     (sXMLPath, RetornoPath: PChar; iUF, iTipo: integer; versaoDados: PChar; iContingencia: integer; retorno_detalhado: Boolean; IgnoreInvalidCert: Boolean): integer; stdcall; external 'transmissaoNFCe32dll.dll';
 function fncNFCeRetAutorizacaoPath  (sXMLPath, RetornoPath: PChar; iUF, iTipo: integer; versaoDados: PChar; iContingencia: integer; retorno_detalhado: Boolean; IgnoreInvalidCert: Boolean): integer; stdcall; external 'transmissaoNFCe32dll.dll';
 function fncNFCeConsultaPath        (sXMLPath, RetornoPath: PChar; iUF, iTipo: integer; versaoDados: PChar; iContingencia: integer; retorno_detalhado: Boolean; IgnoreInvalidCert: Boolean): integer; stdcall; external 'transmissaoNFCe32dll.dll';
 function fncNFCeInutilizacaoPath    (sXMLPath, RetornoPath: PChar; iUF, iTipo: integer; versaoDados: PChar; iContingencia: integer; retorno_detalhado: Boolean; IgnoreInvalidCert: Boolean): integer; stdcall; external 'transmissaoNFCe32dll.dll';
 function fncNFCeStatusServicoPath   (sXMLPath, RetornoPath: PChar; iUF, iTipo: integer; versaoDados: PChar; iContingencia: integer; retorno_detalhado: Boolean; IgnoreInvalidCert: Boolean): integer; stdcall; external 'transmissaoNFCe32dll.dll';
 function fncNFCeRecepcaoEventoPath  (sXMLPath, RetornoPath: PChar; iUF, iTipo: integer; versaoDados: PChar; iContingencia: integer; retorno_detalhado: Boolean; IgnoreInvalidCert: Boolean): integer; stdcall; external 'transmissaoNFCe32dll.dll';
...
//Alterada em 26/11/2013 para incluir as opções 'SVAN','SVRS','SVCAN', 'SVCRS'
//Alterada em 05/05/2014 retirada as opões 'SVCAN', 'SVCRS' que passaram para a opção de contingência e 'SVAN','SVRS'
//a DLL já faz o tratamento para os estados que usam 'SVAN'e 'SVRS'
function Cod_UF_IBGE(MyUF: String): integer;
var
 i: integer;
const
 UF: array[1..27] of String[2] = ('RO','AC','AM','RR','PA','AP','TO','MA','PI','CE','RN','PB','PE',
                                  'AL','SE','BA','MG','ES','RJ','SP','PR','SC','RS','MS','MT','GO','DF'); //,'SV','VC');
 Cod_IBGE: array[1..27] of integer = (11,12,13,14,15,16,17,21,22,23,24,25,26,
                                      27,28,29,31,32,33,35,41,42,43,50,51,52,5); //,-3,-4);
begin
 result := -1;
...
var
 MyiUF, MyiTipo, i, MyiContingencia: Integer;
...
begin
 try
  ...
  MyiContingencia  := ComboBox3.ItemIndex;                      //Serviços de Contingência
  ...
  case radiogroup1.ItemIndex of
   0: retorno := fncNFCeAutorizacao     (MysXML, MyiUF, MyiTipo, MyversaoDados, MyiContingencia, checkbox3.checked, checkbox4.checked);
   1: retorno := fncNFCeRetAutorizacao  (MysXML, MyiUF, MyiTipo, MyversaoDados, MyiContingencia, checkbox3.checked, checkbox4.checked);
   2: retorno := fncNFCeConsulta        (MysXML, MyiUF, MyiTipo, MyversaoDados, MyiContingencia, checkbox3.checked, checkbox4.checked);
   3: retorno := fncNFCeInutilizacao    (MysXML, MyiUF, MyiTipo, MyversaoDados, MyiContingencia, checkbox3.checked, checkbox4.checked);
   4: retorno := fncNFCeStatusServico   (MysXML, MyiUF, MyiTipo, MyversaoDados, MyiContingencia, checkbox3.checked, checkbox4.checked);
   5: retorno := fncNFCeRecepcaoEvento  (MysXML, MyiUF, MyiTipo, MyversaoDados, MyiContingencia, checkbox3.checked, checkbox4.checked);
  end;
...
var
 MyiUF, MyiTipo, MyiContingencia: Integer;
 MysXML, MyversaoDados: PChar;
 datahora_ini, datahorafim: TDateTime;
begin
 try
  ...
  //Consulte Manual de Integração para informações referentes ao valores dos parâmetros versão e versaoDados no cabeçalho da transmissão
  case radiogroup1.ItemIndex of
   0: memo2.Lines.Text := inttostr(fncNFCeAutorizacaoPath     (PChar(xml_filename), PChar(edit1.text), MyiUF, MyiTipo, MyversaoDados, MyiContingencia, checkbox3.checked, checkbox4.checked));
   1: memo2.Lines.Text := inttostr(fncNFCeRetAutorizacaoPath  (PChar(xml_filename), PChar(edit1.text), MyiUF, MyiTipo, MyversaoDados, MyiContingencia, checkbox3.checked, checkbox4.checked));
   2: memo2.Lines.Text := inttostr(fncNFCeConsultaPath        (PChar(xml_filename), PChar(edit1.text), MyiUF, MyiTipo, MyversaoDados, MyiContingencia, checkbox3.checked, checkbox4.checked));
   3: memo2.Lines.Text := inttostr(fncNFCeInutilizacaoPath    (PChar(xml_filename), PChar(edit1.text), MyiUF, MyiTipo, MyversaoDados, MyiContingencia, checkbox3.checked, checkbox4.checked));
   4: memo2.Lines.Text := inttostr(fncNFCeStatusServicoPath   (PChar(xml_filename), PChar(edit1.text), MyiUF, MyiTipo, MyversaoDados, MyiContingencia, checkbox3.checked, checkbox4.checked));
   5: memo2.Lines.Text := inttostr(fncNFCeRecepcaoEventoPath  (PChar(xml_filename), PChar(edit1.text), MyiUF, MyiTipo, MyversaoDados, MyiContingencia, checkbox3.checked, checkbox4.checked));
  end;
